...
testDisplayEncoding cfg msg senc = TestCase $ assertEqual ("Incorrect encoding display for " ++ show cfg)
        senc
        (lines $ displayEnigmaEncoding cfg msg)
...
main = do
        ...
        putStrLn $ displayEnigmaConfig (configEnigma "----" "AAAA" "" "01.01.01.01") ' ' displayOpts
        putStrLn "\nDisplay test - '@':"
        putStrLn $ displayEnigmaConfig (configEnigma "----" "AAAA" "" "01.01.01.01") '@' displayOpts
        putStrLn "\nDisplay test - '\\':"
        putStrLn $ displayEnigmaConfig (configEnigma "----" "AAAA" "" "01.01.01.01") '\\' displayOpts
        ...
        putStrLn $ displayEnigmaOperation (configEnigma "----" "AAAA" "~" "01.01.10.01") ['A'..'Z'] displayOpts
        putStrLn "Encoding display test:"
        putStrLn $ displayEnigmaEncoding (configEnigma "----" "AAAA" " " "01.01.10.01") (concatMap (replicate 8) ['A'..'Z'])
